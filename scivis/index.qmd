...
1. [Download today's materials](https://bit.ly/paraviewzipp) as a single ZIP file with slides (two PDFs), data
and scripts inside. Unpack it where you can find it on your computer.

2. [Install recent ParaView](http://www.paraview.org/download) on your computer. Make sure it runs, i.e. you
   have installed the right version for your operating system and processor architecture.
