...
- Lots of interesting design decisions, e.g. macros, support for Unicode, etc. — covered in
  [our introductory Julia course](https://wgtm21.netlify.app/programming_julia/)
...
If you would like to install Julia later on, you can find some information [here](/julia-installation).
...
![](img/julia_repl_modes.png){fig-alt="noshadow"}
...
[Here](https://carolchen.me/blog/technical/jits-intro/) is a great blog post covering this topic if you want to dive deeper into the functioning of JIT compilers.

### Macros

In the tradition of Lisp, Julia has [strong metaprogramming capabilities](https://en.wikibooks.org/wiki/Introducing_Julia/Metaprogramming#Macros), in particular in the form of macros.

Macros are parsed and evaluated first, then their output gets evaluated like a classic expression. This allows the language to modify itself in a [reflective](https://en.wikipedia.org/wiki/Reflective_programming) manner.
...
[Julia supports unicode](https://docs.julialang.org/en/v1/manual/unicode-input/). In a Julia REPL, type the following, followed by the TAB key:
...
[Our introduction to Julia course](https://wgtm21.netlify.app/programming_julia/) has, amongst others, sections on:

- [how to access help/documentation and links to a lot of resources](https://westgrid-julia.netlify.app/2021_modules/04_jl_doc/)
- [packages](https://westgrid-julia.netlify.app/2021_modules/06_jl_pkg/)
- [collections](https://westgrid-julia.netlify.app/2021_modules/09_jl_collections/)
- [basic functions](https://westgrid-julia.netlify.app/2021_modules/10_jl_functions/)
- [control flow](https://westgrid-julia.netlify.app/2021_modules/11_jl_control_flow/)
